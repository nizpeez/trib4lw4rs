...
<table>
    ...
    <tr>
        <th>Set Resources:</th>
        <td class="res"><input type="number" id="manualWood" placeholder="" style="width: 50px;"></td>
        <td class="res"><input type="number" id="manualStone" placeholder="" style="width: 50px;"></td>
        <td class="res"><input type="number" id="manualIron" placeholder="" style="width: 50px;"></td>
        <td>
